...
const Navbar = () => {
    ...
    return (
        <div className='fixed w-full h-[80px] flex justify-between items-center px-4 bg-[#323232] text-gray-100'>

            <div>
                <img src={Logo} alt="Erick Sanggor" style={{ width: '100px' }} />
            </div>


            <ul className='hidden md:flex'>
                <li className='text-[#FF1E56] font-bold'> <Link to="home" smooth={true} duration={500}>
                    Erick Sanggor
                </Link></li>
            ...
            <ul className={!nav ? 'hidden' : 'absolute top-0 left-0 w-full h-screen bg-[#252525] flex flex-col justify-center items-center'}>
                <li className='py-6 text-4xl text-[#FF1E56] font-bold'><Link onClick={handleClick} to="home" smooth={true} duration={500}>
                    Erick Sanggor
                </Link></li>
